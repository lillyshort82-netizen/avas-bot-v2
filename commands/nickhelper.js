...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!member) {
      return message.channel.send('usage: `!nickhelper @user name timezone`').catch(() => {});
    }
    ...
    const newNickname = `${displayName} Ი︵𐑼 helper ､､ ${timezone}`;
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setTimestamp()
        .setDescription(`
# <:aa_tick:1482041798221369354> **helping hand setup complete**
hey there, ${member}
