...
module.exports = {
  ...
  async execute(message) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setTimestamp()
      .setDescription(`
# <:aa_star:1478802523190984727> **pastry promoter training - part 3 (communication & support)**
${user}  

<:aa_heart:1478802351279312928> pastry promoters may also answer **questions from interested members or potential customers**

<:aa_star:1478802523190984727> **when responding to users:**  
> be polite and approachable  
> answer clearly and accurately  
> don’t ignore questions or respond rudely  

<:aa_exclaim:1481030077121564894> **if someone is interested:**  
> explain what the server offers  
> guide them to the correct channels or website  
> encourage them in a friendly way  
...
reply with **next** or react with <:aa_tick:1482041798221369354> to continue
    ...
    const goNext = async () => {
      ...
      const nextCommand = message.client.commands.get('promo4');
      if (nextCommand) {
